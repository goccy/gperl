...
CFLAGS = -O0 -g3 -gdwarf-2 -Wall -W -fpermissive -I./include/ -I$(READLINE_DIR)/include -I/opt/local/include/ -DDEBUG_MODE -DUSING_JIT #-DUSING_GRAPH_DEBUG
READLINE_CFLAGS= -O2 -Wall -W -I$(READLINE_DIR)/include/
LDLIBS = -L/usr/local/lib/x86_64 -ljit -lpthread -lgvc -lgraph #`pkg-config libgvc --libs` -lpthread
target = gperl
