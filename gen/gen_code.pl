...
sub get_write_data {
    ...
    my @DOUBLE_CHECK_LIST = qw{ADD SUB MUL DIV LSHIFT RSHIFT JL JG JLE JGE JE JNE AND OR};
    my @CONST_CHECK_LIST = qw{IS ISNOT JL JG JLE JGE JE JNE AND OR ADD SUB MUL DIV LSHIFT RSHIFT};
    my @CMP_JMP_LIST = qw{JL JG JLE JGE JE JNE AND OR};
