	static void *jmp_table[] = {
	    ...
	    &&L(dJNEC), &&L(iJNEC), &&L(IS),
	    &&L(dIS), &&L(iIS), &&L(sIS),
	    &&L(oIS), &&L(dISC), &&L(iISC),
	    &&L(ISNOT), &&L(dISNOT), &&L(iISNOT),
	    &&L(sISNOT), &&L(oISNOT), &&L(dISNOTC),
	    &&L(iISNOTC), &&L(StringADD), &&L(dStringADD),
	    &&L(iStringADD), &&L(sStringADD), &&L(oStringADD),
	    &&L(dStringADDC), &&L(iStringADDC), &&L(INC),
	...
	static InstBlock block_table[] = {
	    ...
	    B(dJNEC), B(iJNEC), B(IS),
	    B(dIS), B(iIS), B(sIS),
	    B(oIS), B(dISC), B(iISC),
	    B(ISNOT), B(dISNOT), B(iISNOT),
	    B(sISNOT), B(oISNOT), B(dISNOTC),
	    B(iISNOTC), B(StringADD), B(dStringADD),
	    B(iStringADD), B(sStringADD), B(oStringADD),
	    B(dStringADDC), B(iStringADDC), B(INC),
