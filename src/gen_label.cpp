	static void *jmp_table[] = {
	    ...
	    &&L(dJNEC), &&L(iJNEC), &&L(StringADD),
	    &&L(dStringADD), &&L(iStringADD), &&L(sStringADD),
	    &&L(oStringADD), &&L(dStringADDC), &&L(iStringADDC),
	    &&L(INC), &&L(dINC), &&L(iINC),
	    &&L(sINC), &&L(oINC), &&L(gINC),
	    &&L(dgINC), &&L(igINC), &&L(sgINC),
	    &&L(ogINC), &&L(DEC), &&L(dDEC),
	    &&L(iDEC), &&L(sDEC), &&L(oDEC),
	    &&L(gDEC), &&L(dgDEC), &&L(igDEC),
	    &&L(sgDEC), &&L(ogDEC), &&L(RET),
	    ...
	    &&L(D_oJNEC), &&L(A_StringADD), &&L(A_dStringADD),
	    &&L(A_iStringADD), &&L(A_sStringADD), &&L(A_oStringADD),
	    &&L(B_StringADD), &&L(B_dStringADD), &&L(B_iStringADD),
	    &&L(B_sStringADD), &&L(B_oStringADD), &&L(C_StringADD),
	    &&L(C_dStringADD), &&L(C_iStringADD), &&L(C_sStringADD),
	    &&L(C_oStringADD), &&L(D_StringADD), &&L(D_dStringADD),
	    ...
	    &&L(D_sStringADDC), &&L(A_RET), &&L(B_RET),
	...
	static InstBlock block_table[] = {
	    ...
	    B(dJNEC), B(iJNEC), B(StringADD),
	    B(dStringADD), B(iStringADD), B(sStringADD),
	    B(oStringADD), B(dStringADDC), B(iStringADDC),
	    B(INC), B(dINC), B(iINC),
	    B(sINC), B(oINC), B(gINC),
	    B(dgINC), B(igINC), B(sgINC),
	    B(ogINC), B(DEC), B(dDEC),
	    B(iDEC), B(sDEC), B(oDEC),
	    B(gDEC), B(dgDEC), B(igDEC),
	    B(sgDEC), B(ogDEC), B(RET),
	    ...
	    B(D_oJNEC), B(A_StringADD), B(A_dStringADD),
	    B(A_iStringADD), B(A_sStringADD), B(A_oStringADD),
	    B(B_StringADD), B(B_dStringADD), B(B_iStringADD),
	    B(B_sStringADD), B(B_oStringADD), B(C_StringADD),
	    B(C_dStringADD), B(C_iStringADD), B(C_sStringADD),
	    B(C_oStringADD), B(D_StringADD), B(D_dStringADD),
	    ...
	    B(D_sStringADDC), B(A_RET), B(B_RET),
